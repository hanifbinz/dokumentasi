        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <!-- /.card-header -->
                    <div class="card-body">
                        <table id="tbl_bongkar" class="table table-bordered table-striped table-hover">
                            <thead>
                                <tr class="bg-info">
                                    <th>No</th>
                                    <th>Uploader</th>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        //datatables
        table = $("#tbl_bongkar").DataTable({
            "responsive": true,
            "autoWidth": false,
            "language": {
                "sEmptyTable": "Data Bongkar Belum Ada"
            },
            ...
            "ajax": {
                "url": "<?php echo site_url('bongkar/ajax_list') ?>",
                "type": "POST"
            },
    ...
    function hapus(id) {
        ...
        Swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    url: "<?php echo site_url('bongkar/delete'); ?>",
                    type: "POST",
                    data: "id=" + id,
                    cache: false,
                    dataType: 'json',
    ...
    function add() {
        ...
        $('.modal-title').text('Add Bongkar'); // Set Title to Bootstrap modal title
    }
    ...
    function edit(id) {
        ...
        $.ajax({
            url: "<?php echo site_url('bongkar/edit') ?>/" + id,
            type: "GET",
            dataType: "JSON",
            success: function(data) {

                $('[name="id"]').val(data.id_bongkar);
                $('[name="tanggal"]').val(data.tanggal);
                $('[name="id_angkutan"]').val(data.id_angkutan).select2();
                $('[name="no_kontainer"]').val(data.no_kontainer);
                $('[name="jumlah_barang"]').val(data.jumlah_barang);
                $('[name="kode_bongkar"]').val(data.kode_bongkar);
                $('[name="id_barang"]').val(data.id_barang).select2();

                $('#modal_form').modal('show'); // show bootstrap modal when complete loaded
                $('.modal-title').text('Edit Bongkar'); // Set title to Bootstrap modal title
    ...
    function save() {
        ...
        if (save_method == 'add') {
            url = "<?php echo site_url('bongkar/insert') ?>";
        } else {
            url = "<?php echo site_url('bongkar/update') ?>";
        }
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content ">
            ...
            <div class="modal-header">
                <h3 class="modal-title">bongkar Form</h3>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group row ">
                                    <label for="nama" class="col-sm-4 col-form-label">No Kontainer</label>
                                    <div class="col-sm-8 kosong">
                                        <input type="text" class="form-control" name="no_kontainer" id="no_kontainer" placeholder="No Kontainer">
                                        <span class="help-block"></span>
                                    </div>
                                </div>
                                <div class="form-group row ">
                                ...
                                <div class="form-group row ">
                                    <label for="nama" class="col-sm-4 col-form-label">Kode Bongkar</label>
                                    <div class="col-sm-8 kosong">
                                        <input type="text" class="form-control" name="kode_bongkar" id="kode_bongkar" placeholder="Kode Bongkar">
                                        <span class="help-block"></span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                ...
                                <div class="form-group row ">
                                    <label for="nama" class="col-sm-4 col-form-label">Foto Kontainer</label>
                                    <div class="col-sm-8 kosong">
                                        <input type="file" class="form-control" name="foto_kontainer" id="foto_kontainer" placeholder="No Kontainer">
                                        <span class="help-block"></span>
                                    </div>
                                </div>
                                <div class="form-group row ">
                                    <label for="nama" class="col-sm-4 col-form-label">Foto SJ</label>
                                    <div class="col-sm-8 kosong">
                                        <input type="file" class="form-control" name="foto_sj" id="foto_sj">
                                        <span class="help-block"></span>
                                    </div>
                                </div>
                                
                                <div class="form-group row ">
                                    <label for="nama" class="col-sm-4 col-form-label">Foto Segel</label>
                                    <div class="col-sm-8 kosong">
