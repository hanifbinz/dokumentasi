...
(101028,'TITANVENE HD 5218 EA','LOTTE CHEMICAL INDONESIA','lokal'),
(101035,'LDF 260 GG','LOTTE CHEMICALS MALAYSIA','impor'),
(102033,'LDC 801 YY','LOTTE CHEMICALS MALAYSIA','impor'),
(204099,'PP PM 803','LOTTE CHEMICAL MALAYSIA','impor');
...
CREATE TABLE `muat` (
  ...
  CONSTRAINT `muat_ibfk_4` FOREIGN KEY (`id_customer`) REFERENCES `customer` (`id_customer`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
