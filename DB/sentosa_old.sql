...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 11, 2024 at 07:52 PM
...
ALTER TABLE `angkutan`
  ADD PRIMARY KEY (`id`,`id_angkutan`);
...
ALTER TABLE `customer`
  ADD PRIMARY KEY (`id`,`id_customer`);
...
ALTER TABLE `muat`
  ...
  ADD KEY `id_user_2` (`id_user`,`id_angkutan`,`id_barang`,`id_customer`);
...
--
ALTER TABLE `bongkar`
  MODIFY `id_bongkar` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
...
--
ALTER TABLE `muat`
  MODIFY `id_muat` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
ALTER TABLE `tbl_submenu`
  MODIFY `id_submenu` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=73;
...
--
ALTER TABLE `tbl_akses_menu`
  ADD CONSTRAINT `tbl_akses_menu_ibfk_1` FOREIGN KEY (`id_level`) REFERENCES `tbl_userlevel` (`id_level`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `tbl_akses_menu_ibfk_2` FOREIGN KEY (`id_menu`) REFERENCES `tbl_menu` (`id_menu`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `tbl_akses_submenu`
--
ALTER TABLE `tbl_akses_submenu`
  ADD CONSTRAINT `tbl_akses_submenu_ibfk_1` FOREIGN KEY (`id_level`) REFERENCES `tbl_userlevel` (`id_level`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `tbl_akses_submenu_ibfk_2` FOREIGN KEY (`id_submenu`) REFERENCES `tbl_submenu` (`id_submenu`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
